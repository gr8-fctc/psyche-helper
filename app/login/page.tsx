        ...
        Sign up
            ...
            className="grid h-full w-full place-items-end place-items-center justify-end border-2 border-solid p-16">
                <div className="flex grid space-y-4">
                    ...
                    <button type="button" className="bg-[#ff8c40] hover:bg-blue-700 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline rounded-md mb-2">Login</button>
