        ...
        Sign up
            ...
            className="grid h-full w-full place-items-end place-items-center justify-end border-2 border-solid p-16">
                ...
                <div className="flex grid space-y-4">
                    ...
                    <h2 className='text-black text-xl'>Register</h2>
                    <label className='block text-gray-700 text-sm mb-2'>Email</label>
                    <input required name="email" type="text" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </input>

                    <label className='block text-gray-700 text-sm mb-2'>Username</label>
                    <input required name="username" type="text" id="username" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </input>

                    <label className="block text-gray-700 text-sm mb-2">Password</label>
                    <input required name="password" id="password" type="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </input>
                    ...
                    <button type="submit" className="bg-[#ff8c40] hover:bg-blue-700 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline rounded-md mb-2">Register</button>


                    <Link href="/login" legacyBehavior>
                        <a className='text-black underline'>Already have an account?</a>
                    </Link>
                </div>
            </form>
            </div>
