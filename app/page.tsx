        ...
        Sign up
            ...
            <div className='grid place-items-start mt-5'>
                <a className='pl-10 text-blue-400 text-2xl font-light'>
                  PsycheHelper is an app designed to help users <br></br> evaluate their mental wellbeing based on four indexes:
                  <br></br>
                  <br></br>
                  * CWI: Cognitive Wellbeing Index
                  <br></br>
                  * SWI: Social Wellbeing Index 
                  <br></br>
                  * EWI: Emotional Wellbeing Index 
                  <br></br>
                  * PWI: Physical Wellbeing Index 
                  <br></br>
                  <br></br>
                  With PsycheHelper, you can track your mental health status <br></br>just by answering a couple of simple questions every day.
                </a>
            </div>
            

            <div className='grid place-items-center bg-[#76c2cc] p-5 mt-5'>
              <a className='text-3xl'>Be on track towards better mental health with</a>
