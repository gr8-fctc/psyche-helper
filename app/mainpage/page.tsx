      ...
      <div>
        <div className="">
          <div className="flex items-center space-x-2 pl-2 pr-2 bg-[#76C2CC] rounded h-16">
            ...
            <div className="pr-3 ltr absolute right-0 "></div>
          </div>
        </div>
      </div>
      <div
      ...
      >
        <div>
          <div>
            ...
            <div>
              <a className="text-blue-500 text-2xl">
                Take 5 minutes to get to know your<br></br> mental health status
              </a>
            </div>
            <div>
              <Link href="https://zu0jojkc77g.typeform.com/to/CVQogpsT">
